...
console.log(Object.keys(errors).length)
  ...
  color: 'transparent'
   ...
   {pending &&  <div className={`absolute inset-0 flex items-center justify-center w-full h-full top-0 left-0`}>
      

<div class={`relative items-center light block max-w-sm p-6 border border-gray-100 rounded-lg shadow-md`}>
   
    <p class={`${theme=='light' ?  'text-black' : 'text-white'} font-normal  opacity-10`}>Votre Message et en cours d'etre envoyer ! Patientez quelque secondes.</p>
